...
const AllEventsScreen = () => {
  ...
  const renderEventItem = ({ item }: { item: Evenement }) => {
    ...
    const defaultImage = "https://images.unsplash.com/photo-1540575861501-7cf05a4b125a?q=80&w=500";
    ...
    return (
      ...
      >
        <Image 
          source={{ uri: item.image ? `http://127.0.0.1:8000/storage/${item.image}` : defaultImage }} 
  ...
  if (loading && !refreshing) {
    return (
      <View style={[BaseStyles.container, { backgroundColor: colors.background, justifyContent: 'center', alignItems: 'center' }]}>
  ...
  return (
    <ScrollView
      refreshControl={
        <RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={[colors.tint1]} />
      }
    >
      <View
            ...
            <View style={[styles.tabBar, { backgroundColor: colors.card }]}>
              ...
              >
                <Text
                  style={[
                    styles.tabLabel,
                    { color: activeTab === "A venir" ? colors.tint2 : colors.text },
                  ]}
                >
              ...
              >
                <Text
                  style={[
                    styles.tabLabel,
                    { color: activeTab === "Passés" ? colors.tint2 : colors.text },
                  ]}
                >
                  Passés ({evenements.filter(e => {
            ...
            <FlatList
              ...
              ListEmptyComponent={
                <View style={styles.emptyContainer}>
                  <Ionicons name="calendar-outline" size={60} color={colors.text} style={{ opacity: 0.3 }} />
